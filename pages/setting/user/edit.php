    ...
    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
      <div class="form-group">
        ...
        <select name="edit_gender" id="edit_gender" class="form-control">
          ...
          <option <?php if ($user_gender == '1') {
                    echo "selected";
                  } ?> value="1">Pria</option>
          <option <?php if ($user_gender == '2') {
                    echo "selected";
    ...
    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
      <div class="form-group">
        ...
        <select name="edit_akses" id="edit_akses" class="form-control">
          ...
          ?>
            <option value="<?= $rowSelect['id']; ?>" <?php if ($rowSelect['id'] == $access_level) {
                                                        echo "SELECTED";
                                                      } ?>><?= $rowSelect['role_description']; ?></option>
          <?php } ?>
        </select>
      </div>
    </div>
