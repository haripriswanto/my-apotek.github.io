    ...
    <tbody>
      ...
      ?>
        ...
        ?>
          ...
          <tr id="selectProductCart" style="cursor: pointer;" product_code="<?php echo $product_code ?>" product_name="<?php echo $product_name; ?>" quantity="<?php echo $quantity; ?>" selling_price="<?php echo $selling_price; ?>" htu_code="<?php echo $htu_code; ?>" htu_name="<?php echo $htu_name; ?>" title="Double Klik Untuk Data Produk : <?php echo $product_name ?>" data-toggle="tooltip" data-placement="bottom">
