...
<table class="table table-hover table-responsive" id="dataPreview">
  ...
  <tbody>
    ...
    $tgl_awal   = mysqli_escape_string($config, $_POST['tgl_awal']);
    $tgl_akhir  = mysqli_escape_string($config, $_POST['tgl_akhir']);
    $status     = mysqli_escape_string($config, $_POST['status']);
    $filter     = '';
