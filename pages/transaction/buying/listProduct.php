...
<div class="panel panel-primary">
      ...
      <tbody>
        ...
        while ($data = mysqli_fetch_array($querySelectProduct)) {
          ...
          if ($jmlMargin <= 2 || $margin == 100) {
            $buying_price = $persen + $buying_price;
          } else if ($jmlMargin > 2 || $margin != 100) {
            $buying_price = $buying_price + $margin;
          }
        ...
        ?>
          <tr id="selectProduct" style="cursor: pointer;" productCode="<?php echo $product_code ?>" productName="<?php echo $product_name; ?>" buyingPrice="<?php echo $buying_price; ?>">
            <td><?php echo $number ?></td>
            <td><?php echo $data['product_code']; ?></td>
            <td><?php echo $data['product_name']; ?></td>
            <td><?php echo number_format($data['product_stock']); ?></td>
            <td><?php echo $unit_description; ?></td>
            <td>Rp. <?php echo number_format(round($buying_price)); ?></td>
  ...
  <script type="text/javascript">
    $(document).on('click', '#selectProduct', function(e) {
      document.getElementById('c_buying_product_code').value = $(this).attr('productCode');
      document.getElementById('c_buying_product_name').value = $(this).attr('productName');
      document.getElementById('c_buying_price').value = $(this).attr('buyingPrice');
      document.getElementById('c_buying_product_qty').value = 1;
    ...
    //   $('#listProduct').modal('hide');
    //   document.getElementById("c_buying_product_code").value = $('#list_product_code').val();
    //   document.getElementById("c_buying_product_name").value = $('#list_product_name').val();    
    //   document.getElementById("c_buying_price").value = $('#list_product_price').val();
    //   document.getElementById('c_buying_product_qty').focus();
    // }
