				...
				<table class="table table-hover">
					<thead>
						...
						<tr>
							...
							<td width="20">:</td>
							<td colspan="4"><?php echo $supplier_description_hdr;
											if ($supplier_code_hdr != '') {
												" (" . $supplier_code_hdr . ")";
											} else {
												echo " -";
											} ?></td>
						...
						<tr>
							...
							<td width="20">:</td>
							<td colspan="4"><?php if ($ts_update_hdr == '') {
												echo $date_insert_hdr . " " . $time_insert_hdr;
											} else {
												echo $ts_update_hdr . " [Batal]";
											} ?></td>
						</tr>
						<!-- <tr>
