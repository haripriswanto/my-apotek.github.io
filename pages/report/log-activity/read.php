...
$tglAwal = mysqli_escape_string($config, $_POST['tglAwal']);
$tglAkhir = mysqli_escape_string($config, $_POST['tglAkhir']);
$user = mysqli_escape_string($config, $_POST['casier_name']);


if ($tglAwal == '' and $tglAkhir == '' and $user == '') {
  ...
  $pesan = "Menampilkan Data Hari Ini";
} elseif ($tglAwal != '' and $tglAkhir != '' and $user == '') {
  $date_in_stock   = $tglAwal;
  $date_out_stock  = $tglAkhir;

  $filterDate = "log_date >= '$date_in_stock 00:00:00' AND log_date <= '$date_out_stock 23:23:59'";
  $pesan = "Menampilkan Data Dari tgl " . $date_in_stock . " S/D " . $date_out_stock;
} elseif ($tglAwal != '' and $tglAkhir != '' and $user != '') {
  $date_in_stock   = $tglAwal;
  $date_out_stock  = $tglAkhir;
  $casier_name     = $user;
